      ...
      <div className="container relative z-10 px-4 mx-auto sm:px-6 lg:px-8">
        <div className="grid gap-8 md:gap-12 lg:grid-cols-2 xl:gap-16">
          ...
          <motion.div 
            ...
            className="relative order-1 flex items-center justify-center mb-8 lg:mb-0 lg:order-2"
          >
            <div className="relative w-full max-w-md mx-auto overflow-hidden rounded-2xl shadow-2xl aspect-square sm:aspect-[4/3] lg:aspect-auto lg:h-full">
              <img
                src={hero}
